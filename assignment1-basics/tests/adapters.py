...
from cs336_basics.bpe import BPE, train_bpe
...
def run_multihead_self_attention(
    ...
    mask = torch.tril(torch.ones(s, s, device=in_features.device)).bool()
...
def run_multihead_self_attention_with_rope(
    ...
    q = rotary_pos_emb(q, theta, token_positions)
    k = rotary_pos_emb(k, theta, token_positions)
...
def run_rope(
    ...
    """
    return rotary_pos_emb(in_query_or_key, theta, token_positions)
